...
describe('Product e2e test', () => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('shy copyright perpetrate');
      cy.get(`[data-cy="name"]`).should('have.value', 'shy copyright perpetrate');

      cy.get(`[data-cy="price"]`).type('30131.69');
      cy.get(`[data-cy="price"]`).should('have.value', '30131.69');
      ...
      cy.get(`[data-cy="category"]`).select('Accessory');

      cy.get(`[data-cy="inventory"]`).type('10586');
      cy.get(`[data-cy="inventory"]`).should('have.value', '10586');
