package com.betterprojectsfaster.tutorial.jhipsterdocker.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.betterprojectsfaster.tutorial.jhipsterdocker.IntegrationTest;
import com.betterprojectsfaster.tutorial.jhipsterdocker.repository.timezone.DateTimeWrapper;
import com.betterprojectsfaster.tutorial.jhipsterdocker.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM bpf_date_time_wrapper where id=%d", fieldName, id);
    }
