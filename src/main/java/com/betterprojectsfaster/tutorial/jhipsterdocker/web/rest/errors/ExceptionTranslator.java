package com.betterprojectsfaster.tutorial.jhipsterdocker.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.betterprojectsfaster.tutorial.jhipsterdocker.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof com.betterprojectsfaster.tutorial.jhipsterdocker.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof com.betterprojectsfaster.tutorial.jhipsterdocker.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "com.betterprojectsfaster.tutorial.jhipsterdocker"
        );
    }
}
