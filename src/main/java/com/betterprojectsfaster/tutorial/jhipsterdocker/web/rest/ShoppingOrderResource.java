...
public class ShoppingOrderResource {
    ...
    public ResponseEntity<ShoppingOrderDTO> createShoppingOrder(@Valid @RequestBody ShoppingOrderDTO shoppingOrderDTO)
        ...
        shoppingOrderDTO = shoppingOrderService.save(shoppingOrderDTO);
        return ResponseEntity.created(new URI("/api/shopping-orders/" + shoppingOrderDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, shoppingOrderDTO.getId().toString()))
            .body(shoppingOrderDTO);
    }
    ...
    public ResponseEntity<ShoppingOrderDTO> updateShoppingOrder(
        ...
        shoppingOrderDTO = shoppingOrderService.update(shoppingOrderDTO);
     ...
     */
    @GetMapping("")
    public List<ShoppingOrderDTO> getAllShoppingOrders(
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ShoppingOrderDTO> getShoppingOrder(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteShoppingOrder(@PathVariable("id") Long id) {
