...
/**
 * Service Implementation for managing {@link com.betterprojectsfaster.tutorial.jhipsterdocker.domain.ShoppingOrder}.
 */
@Service
@Transactional
public class ShoppingOrderServiceImpl implements ShoppingOrderService {
    ...
    @Override
    public ShoppingOrderDTO update(ShoppingOrderDTO shoppingOrderDTO) {
        log.debug("Request to update ShoppingOrder : {}", shoppingOrderDTO);
        ShoppingOrder shoppingOrder = shoppingOrderMapper.toEntity(shoppingOrderDTO);
        shoppingOrder = shoppingOrderRepository.save(shoppingOrder);
        return shoppingOrderMapper.toDto(shoppingOrder);
    }
    ...
    public Page<ShoppingOrderDTO> findAllWithEagerRelationships(Pageable pageable) {
        return shoppingOrderRepository.findAllWithEagerRelationships(pageable).map(shoppingOrderMapper::toDto);
    }
    ...
    public List<ShoppingOrderDTO> findAllWhereShipmentIsNull() {
        ...
        return StreamSupport.stream(shoppingOrderRepository.findAll().spliterator(), false)
    ...
    public Optional<ShoppingOrderDTO> findOne(Long id) {
        ...
        return shoppingOrderRepository.findOneWithEagerRelationships(id).map(shoppingOrderMapper::toDto);
    }
