          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="mySimpleShopApp.productOrder.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="mySimpleShopApp.productOrder.buyer">Buyer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
