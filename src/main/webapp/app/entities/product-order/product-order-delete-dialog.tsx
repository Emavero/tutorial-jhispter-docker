...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mySimpleShopApp.productOrder.delete.question">
        <Translate contentKey="mySimpleShopApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="bpf-confirm-delete-productOrder" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
