...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mySimpleShopApp.address.delete.question">
        <Translate contentKey="mySimpleShopApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="bpf-confirm-delete-address" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
