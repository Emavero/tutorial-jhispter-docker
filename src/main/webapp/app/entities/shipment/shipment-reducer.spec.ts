...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './shipment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHIPMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHIPMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SHIPMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SHIPMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHIPMENT actions', async () => {
      const arg = 42666;
