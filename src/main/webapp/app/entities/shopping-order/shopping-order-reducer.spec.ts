...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHOPPINGORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHOPPINGORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHOPPINGORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SHOPPINGORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SHOPPINGORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHOPPINGORDER actions', async () => {
      const arg = 42666;
